...
row = name_with_tag + message_with_tag +like_button + like_button + span_with_tag;
...
function updateLike(message_id)
{
      ...
      console.told(updated_likes);

      firebase.database().ref(room_name).child(message_id).upate({
            like : updated_lines
      });
